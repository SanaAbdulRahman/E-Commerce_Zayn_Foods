(function ($) {
  ...
  // My Account
  $(".js-show-myaccount").on("click", function () {
    $(".js-panel-myaccount").addClass("show-header-myaccount");
  });
  $(".js-hide-myaccount").on("click", function () {
    $(".js-panel-myaccount").removeClass("show-header-myaccount");
  });
  ...
  $(".js-hide-editInfo").on("click", function () {
